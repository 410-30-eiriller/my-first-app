...
height_cm = st.number_input("หรอกส่วนสูงของคุณ (เซนติเมตร):", min_value=1.0, value=1.0)
...
if st.button("คำนวณค่า BMI 🎯"):
    ...
    st.write("---")
    st.header(f"ค่า BMI ของคุณคือ: **{bmi:.f}**")
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
   if bmi < 18.5:
     ...
     si.info("💡 คุณเรื่มมีน้ำหนักเกินเกณฑ์ (ท้วม)")
   else:
